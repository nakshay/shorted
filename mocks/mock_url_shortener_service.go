...
func (m *MockURLShortenerService) GetFullURL(ctx *gin.Context, url string) (string, *error.ShortedError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFullURL", ctx, url)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(*error.ShortedError)
	return ret0, ret1
}
...
func (m *MockURLShortenerService) GetShortenedURL(ctx *gin.Context, url string) (model.ShortUrlResponse, *error.ShortedError) {
	m.ctrl.T.Helper()
